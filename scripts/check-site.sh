...
check_privacy "pt-br" "Melhorar uma foto"                "Aprender de quais fotos"          "Voltar ao original"
...
check_privacy "pl"    "Ulepszanie zdjęcia"               "Uczenie się, które zdjęcia"       "Przywróć oryginał"
check_privacy "tr"    "fotoğrafı iyileştirmek"           "yeğlediğini öğrenmek"             "Orijinale dön"
check_privacy "zh-hant" "增強你要留下的照片"                "學習你偏好哪些照片"                "還原為原始照片"
